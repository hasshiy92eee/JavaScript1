...
let tekiMaster =
    [
        new TekiMaster(0, 10, 1, 100),		//0,人間に飼いならされたクマ
        new TekiMaster(1, 10, 1, 100),		//1,人間に作られたメカひよこ
        new TekiMaster(2, 70, 5000, 10000),		//2,ボス（人類リーダー）
        new TekiMaster(3, 10, 1, 10),		//3,
    ]
...
//スプライト座標
let sprite = [
    new Sprite(0, 0, 23, 42),//0,自機 左2
    new Sprite(24, 0, 36, 42),//1,自機 左1
    new Sprite(60, 0, 47, 42),//2,自機 正面
    new Sprite(106, 0, 38, 42),//3,自機 右1
    new Sprite(144, 0, 24, 42),//4,自機 右2
    ...
    new Sprite(73, 40, 21, 5),// 9,噴射 正面
    new Sprite(108, 42, 21, 5),//10,噴射 右1
    new Sprite(148, 42, 16, 5),//11,噴射 右2
    ...
    new Sprite(4, 194, 24, 28),	//56  ,鶏1
    new Sprite(36, 194, 24, 28),	//57  ,鶏2
    new Sprite(68, 194, 24, 28),	//58  ,鶏3
    new Sprite(100, 194, 24, 28),	//59  ,鶏4
    new Sprite(133, 194, 24, 30),	//60  ,鶏5
    new Sprite(161, 194, 30, 28),	//61  ,鶏6
